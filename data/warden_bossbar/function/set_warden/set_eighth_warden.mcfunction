...
execute at @a if entity @e[type=warden,tag=eighth_warden,distance=100..] run function warden_bossbar:unset_warden/unset_eighth_warden
execute at @a unless entity @e[type=warden,tag=eighth_warden,distance=..100] run function warden_bossbar:unset_warden/unset_eighth_warden