...
execute at @a if entity @e[type=warden,tag=second_warden,distance=100..] run function warden_bossbar:unset_warden/unset_second_warden
execute at @a unless entity @e[type=warden,tag=second_warden,distance=..100] run function warden_bossbar:unset_warden/unset_second_warden